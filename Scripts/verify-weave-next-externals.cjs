...
const REQUIRED = ['index.mjs', 'index.js', 'index.d.ts', 'server.mjs', 'server.js', 'server.d.ts'];
let failed = 0;
...
console.log(
  '[externals] OK — two entries emitted; dist/server.mjs externalizes React/peers (no inlined React).',
);
