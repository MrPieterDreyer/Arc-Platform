...
/**
 * @weave/react/client — the client-only subpath (D-08, D-13).
 *
 * The ONLY client component in @weave/react lives here: <SectionErrorBoundary>.
 * Importing this barrel from a Server Component throws at build time via the
 * `client-only` guard, keeping the RSC-safe main barrel (`@weave/react`) free of
