...
import { SectionRenderer } from '@weave/react';
 ...
 * `loadPageConfig(slug)` (cached + draft-aware, Plan 02) and delegates to `@weave/react`'s
 ...
 * graph — it is reached via the `@weave/next/server` barrel, not the RSC-safe main barrel.
 */
